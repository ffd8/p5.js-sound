...
!(__WEBPACK_AMD_DEFINE_RESULT__ = (function (require) {
  ...
  p5.Oscillator = function (freq, type) {
    ...
    if (type == 'custom') {
      ...
      // this.real[1] = 1;
      // this.imag[1] = 0;
      this.wave = p5sound.audiocontext.createPeriodicWave([0], [0], {
  ...
  p5.Oscillator.prototype.start = function (time, f) {
    ...
    if (!this.started) {
      ...
      time = time || 0; // this.oscillator.start(time + p5sound.audiocontext.currentTime);
  ...
  p5.Oscillator.prototype.setWaveTable = function (wavetable) {
    if (wavetable.length > 0) {
      ...
      ft.forward(wavetable); // this.real = new Float32Array(wavetable.length);
      ...
      this.wave = p5sound.audiocontext.createPeriodicWave(ft.real, ft.imag, {
        disableNormalization: true
      });
      this.start(0);
    }
