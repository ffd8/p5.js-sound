...
!(__WEBPACK_AMD_DEFINE_RESULT__ = (function (require) {
  ...
  p5.Oscillator = function (freq, type) {
    ...
    this.oscillator = p5sound.audiocontext.createOscillator(); // custom waveforms
    // this.waveSize = 512;

    this.real = new Float32Array(2);
    this.imag = new Float32Array(2); // for(var i=0; i<this.real.length;i++){
  ...
  p5.Oscillator.prototype.setWaveTable = function (wavetable) {
    ...
    if (wavetable.length > 0) {
      ...
      this.wave = p5sound.audiocontext.createPeriodicWave(this.real, this.imag); //this.start();
    }
  };
...
!(__WEBPACK_AMD_DEFINE_RESULT__ = (function (require) {
  var p5sound = __webpack_require__(1); // var Add = require('Tone/signal/Add');
  ...
  p5.waveSynth = function () {
    ...
    this.context = p5sound.audiocontext; // this.node = this.context.createScriptProcessor(512, 2, 2);
    ...
    this.osc.frequency.value = 80.0; // this.osc.loop = true;
    ...
    this.envTime = 1.0;
    this.isPlaying = false; // this.wave = new Array(this.waveFormSize);
  ...
  p5.waveSynth.prototype.stop = function () {
    this.osc.disconnect(); //this.osc.stop(this.context.currentTime + 1);
  ...
  p5.waveSynth.prototype.setDelayAmount = function (t) {
    this.delayGain.gain.value = t; //  this.delayGain.gain.cancelScheduledValues(context.currentTime);
  ...
  p5.waveSynth.prototype.filterRamp = function (freq, envTime) {
    ...
    this.filter.frequency.linearRampToValueAtTime(freq, this.context.currentTime + envTime / 1000.); //  this.filter.frequency.value = freq;
    //  this.filter.Q.value = res;
  };
}).call(exports, __webpack_require__, exports, module),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
